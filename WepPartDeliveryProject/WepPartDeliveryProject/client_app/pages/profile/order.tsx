...
const Order: FC<{ categories: categoryItem[]}> = ({ categories }) => {
    ...
    const [orderInfo, setOrderInfo] = useState<orderInfo>({ order: {id:"", deliveryAddress: "", price:0, sumWeight:0, DeleteCardFromList: (orderId)=>{} }, orderedDishes: []});
    ...
    return (
        <>
            <ClientLayout categories={categories}>
                <OrderCard {...orderInfo.order} DeleteCardFromList={handleDeleteOrder} />
                <Row className="mt-3 ">
                    <Col >
