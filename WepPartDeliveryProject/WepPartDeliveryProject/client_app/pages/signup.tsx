...
class Login extends Component<WithRouterProps, LoginState> {
    ...
    handleInputPasswordSecond = (e:ChangeEvent<HTMLInputElement>):void => {
        const inputText = e.target.value;
                    ...
                    <Row>
                        <Col sm={10} md={6} lg={4}>
                            ...
                            <Form.Group className={`mb-3`}>
                                ...
                                <Form.Control type="password" placeholder="Введите пароль" value={this.state.password} onChange={this.handleInputPasswordSecond}/>
                                <span className="text-danger"></span>
                            </Form.Group>
                            <Row>
